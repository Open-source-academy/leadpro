...
<table align="center" bordercolor="#819FF7" border="1" cellspacing=".3" width ="800">
		
<tr bgcolor="#819FF7" align="center">
<td>P.No</td><td>NAME</td><td>MOBILE</td><td>ADDRESS </td><td>EMAIL</td><td>PRODUCT</td>
</tr>
<%while(rs.next()){ %>
<tr>
<TD valign="top"><%=rs.getString(1) %></TD><TD valign="top"><%=rs.getString(2) %></TD><TD valign="top"><%=rs.getString(3) %></TD><TD valign="top"><textarea rows="4" cols="15"><%=rs.getString(4) %></textarea></TD><TD  valign="top"><%=rs.getString(5) %></TD><TD valign="top"><%=rs.getString(6) %></TD>
</tr>
<%} %>
</table>
