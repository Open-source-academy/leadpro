...
<html>
<head>
<title>new Control Panel layout</title>
...
<table width="1000" height="368" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		...
		<!---Working Place--->
		<form action="insertDataToTable.jsp" method="post">
  	<br>
  	<table align="center">
  	...
  	%>
  <tr>	
  <th bgcolor="blue" ><font color="white"><%=md.getColumnName(i) %></font></th>
...
<map name="Map"><area shape="rect" coords="20,13,253,94" href="#"></map></body>
</html>