...
<table width="1000" height="368" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
     ...
     { 
     %>
     <td><input type="text" value="<%=rs1.getString(j)%>" name="editValue"></td>
     <%
     }
     %>
   <td><a href="#"></a></td><td><a href="deleteInfo.jsp?id=<%=rs1.getInt(1) %>&table=<%=table %>"><img height="18" width="18" src="images/delete.jpg" alt="Delete"></a></td> </tr>
     <%} %>
     </table>
     </form><table align="center">
<tr>
<td>
<input type="image" src="images/back.png" onclick="window.history.go(-1)" width="75" height="30" alt="Go Back">
</td>
</tr>
</table>
     <!-- end  -->
