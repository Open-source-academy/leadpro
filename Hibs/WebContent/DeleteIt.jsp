...
rs=con.createStatement().executeQuery("select temp_name,temp from mailTemp");
 %>
...
bgcolor="#FFFFFF">
	...
	<tr>
		...
		<td rowspan="2"><a href="UserHome.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image15','','images/layout_button_03.gif',1)"><img src="images/layout_03.gif" name="Image15" width="181" height="103" border="0" alt="Back to HOME"></a></td>
		<td rowspan="2">
